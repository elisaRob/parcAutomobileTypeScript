const recuperationPourLaListeDeroulante = document.querySelector(".pourLaListeDeroulante")! as HTMLSelectElement;
const recuperationBouton=document.getElementsByTagName("button")[0]! as HTMLButtonElement
